$(document).ready(function() {
        ...
        $.get(url, function(data) {
            ...
            if (mishnaItem) {
                ...
                $.get(apiUrl, function(textData) {
                    console.log("Data from text API:", textData);
                    ...
                    $.get(comUrl, function(dataCom) {
                        console.log("Data from commentary API:", dataCom);
    ...
    // Automatically fetch the Mishna and commentary when the page loads
    fetchMishnaAndCommentary();
});
